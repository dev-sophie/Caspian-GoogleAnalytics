...
class Caspian_GoogleAnalytics {
	...
	public function __construct() {
		if ( defined( 'CASPIAN_GOOGLEANALYTICS_VERSION' ) ) {
			$this->version = CASPIAN_GOOGLEANALYTICS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'caspian-googleanalytics';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-caspian-googleanalytics-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-caspian-googleanalytics-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-caspian-googleanalytics-admin.php';
