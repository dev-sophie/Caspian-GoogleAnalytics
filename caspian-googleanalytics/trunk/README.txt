...
Contributors: sophiekristin
Donate link: https://sophie-senftleben.de/
Tags: tracking, trackingcode, google, analytics, googleanalytics, gtag
...
Caspian GoogleAnalytics is a small plugin that inserts your GoogleAnalytics Tracking Code in the right place, simple and easy.
...
This plugin is based on the [WordPress Plugin Boilerplate](https://github.com/DevinVinson/WordPress-Plugin-Boilerplate) for a *standardized, organized and object-oriented* codebase.
